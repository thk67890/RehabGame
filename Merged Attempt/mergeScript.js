window.addEventListener('load', function() {
    ...
    // Callback to process MediaPipe Pose results and simulate key presses
    pose.onResults((results) => {
        if (results.poseLandmarks) {
            ...
            if (rightShoulder && rightHip && rightKnee && rightAnkle) {
                ...
                // Simulate key press based on angle
                if (HSangle < 90) {
                    simulateKeyPress('ArrowLeft', 'keydown');
                    simulateKeyPress('ArrowRight', 'keyup');
                } 
                
                else if(HSangle >90){
                    simulateKeyPress('ArrowRight', 'keydown');
                    simulateKeyPress('ArrowLeft', 'keyup');
                }
